...
export const poseCatalog: SilhouetteCatalogItem[] = [
  ...
  {id: 'walking', name: '自然走路', category: '人物', width: 0.38, height: 0.68, hint: '前後腳錯開，朝前進方向保留空間。'},
  {id: 'arms-crossed', name: '抱胸站姿', category: '人物', width: 0.34, height: 0.68, hint: '肩線放鬆，雙手自然交疊於胸前。'},
  {id: 'waving', name: '揮手', category: '人物', width: 0.42, height: 0.68, hint: '手臂向外展開，手掌與頭部不要重疊。'},
  {id: 'kneeling', name: '單膝姿勢', category: '人物', width: 0.48, height: 0.52, hint: '重心放低，讓彎曲腿與身體形成清楚輪廓。'},
  {id: 'selfie', name: '側身自拍', category: '人物', width: 0.42, height: 0.62, hint: '手機略高於眼睛，臉部朝鏡頭並保留手臂線條。'},
  {id: 'street-coat', name: '外套街拍', category: '人物', width: 0.4, height: 0.7, hint: '保留外套肩線、袖口與鞋型，適合自然街頭全身照。'},
  {id: 'male-suit', name: '男生西裝', category: '人物', width: 0.35, height: 0.7, hint: '肩線保持水平，雙腳微微分開，適合正式全身照。'},
  {id: 'male-pocket', name: '男生插袋', category: '人物', width: 0.38, height: 0.69, hint: '身體微側、單手插袋，朝視線方向保留空間。'},
  {id: 'male-lean', name: '男生靠牆', category: '人物', width: 0.42, height: 0.68, hint: '肩膀輕靠牆面，一腳彎曲，畫面保留環境線條。'},
  {id: 'female-dress', name: '女生洋裝', category: '人物', width: 0.42, height: 0.7, hint: '裙襬完整留在畫面內，身體重心自然偏向單腳。'},
  {id: 'female-cross-leg', name: '女生交叉腿', category: '人物', width: 0.36, height: 0.69, hint: '前腳輕跨並放鬆肩線，適合時尚全身照。'},
  {id: 'female-street-side', name: '女生側身', category: '人物', width: 0.38, height: 0.69, hint: '身體側轉並回望鏡頭，在面部朝向處保留留白。'},
  ...
  {id: 'cat', name: '貓咪坐姿', category: '寵物', width: 0.38, height: 0.46, hint: '鏡頭對齊眼睛，耳朵與尾巴都保留在畫面內。'},
  {id: 'product', name: '商品主體', category: '商品', width: 0.42, height: 0.46, hint: '商品置中並留出邊界，避免背景線條穿過主體。'},
  {id: 'bottle', name: '瓶罐商品', category: '商品', width: 0.3, height: 0.56, hint: '保持瓶身垂直，標籤正對鏡頭並在上下保留空間。'},
];
